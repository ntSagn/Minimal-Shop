                    ...
                    <div class="container-fluid">
                        ...
                        <div id="form-quan-ao" class="d-none mt-2">
                            <form id="addFormShirt">
                                ...
                                <div class="group-btn d-flex justify-content-between" style="text-align:right; margin-bottom: 2rem;">
                                    <button class="btn btn-secondary"><a href="./list-products.php" class="text-decoration-none text-white">Quay lại</a></button>
                                    <button type="submit" class="btn btn-primary" onclick="addProduct(event)">Thêm</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div id="form-tui-xach" class="d-none mt-2">
                            <form id="addFormBag">
                                ...
                                <div class="mb-3">
                                    <label for="describeProduct" class="form-label fw-bold">Mô tả</label>
                                    <textarea class="form-control" id="describeProduct" name="describeProduct"></textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="color" class="form-label fw-bold">Màu sắc</label>
